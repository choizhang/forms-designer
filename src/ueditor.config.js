...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            'fullscreen', 'source', 'copy', 'cut', 'paste', 'inserttable', '|', 'undo', 'redo', '|',
 ...
 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
            ...
            'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|', 'charts'
        ],
            ...
            [['属性', 'edittable', 'edittd'], ['插入表格', 'inserttable', 'deletetable', 'insertparagraphbeforetable'], ['插入', 'insertrow', 'insertrownext', 'insertcol', 'insertcolnext'], ['删除', 'deleterow', 'deletecol'], ['合并', 'mergecells', 'mergeright', 'mergedown'], ['分割',  'splittocells', 'splittorows', 'splittocols'], ['均分',  'averagedistributerow', 'averagedistributecol', 'averagedistribute'], ['表格对齐', 'tableleft', 'tablecenter', 'tableright'], ['单元格对齐', 'celltl', 'celltc', 'celltr', 'cellml', 'cellmc', 'cellmr', 'cellbl', 'cellbc', 'cellbr']],
