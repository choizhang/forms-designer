UE.registerUI('button', function (editor, uiName) {
    ...
    var btn = new UE.ui.Button({
        ...
        onclick: function () {
            ...
            editor.execCommand( 'inserthtml', '<table draggable="false" class="component com-text editorComp_' + newCount + '"><tr class="firstRow"><br><td width="30" height="20"><hr class="component-handle"><input type="text" class="name" value="文本域"></td></tr></table>');
